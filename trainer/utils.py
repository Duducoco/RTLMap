...
def train_model(
    ...
    module = DualGraphLightningModule(
        ...
        iou_rank_loss_weight=trainer_config.iou_rank_loss_weight,
        iou_rank_margin=trainer_config.iou_rank_margin,
        iou_rank_min_target_gap=trainer_config.iou_rank_min_target_gap,

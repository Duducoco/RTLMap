...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / 'designs' / 'cv32e40p' / 'json'
...
class YosysRunner:
    ...
    def _setup_environment(self) -> dict:
        ...
        env['GDK_PIXBUF_MODULEDIR'] = str(self.oss_cad_suite_path / 'lib' / 'gdk-pixbuf-2.0' / '2.10.0' / 'loaders')
        env['GDK_PIXBUF_MODULE_FILE'] = str(self.oss_cad_suite_path / 'lib' / 'gdk-pixbuf-2.0' / '2.10.0' / 'loaders.cache')
        
        # OPENFPGALOADER_SOJ_DIR
        env['OPENFPGALOADER_SOJ_DIR'] = str(self.oss_cad_suite_path / 'share' / 'openFPGALoader')
    ...
    def run_slang_to_json(self, top_module: str, output_dir: Union[str, Path], 
        ...
        pre_synth_command = ['flatten', 'proc', 'opt_clean', 'opt_muxtree', 'opt_reduce', 'opt_merge', 'opt_clean']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", default=str(DEFAULT_OUTPUT_DIR), help="Directory to save the output JSON")
